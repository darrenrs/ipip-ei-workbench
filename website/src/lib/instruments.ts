...
export const instruments: Instrument[] = [
  {
    ...
    shortName: "Big Five",
    modelAuthor: "General",
    summary: "Boiling down personality to five dimensions.",
    description:
  ...
  },
  {
    ...
    summary:
      "Brain-based systems that control a person's interaction with their environment.",
    description:
    ...
    previewScales: ["Anxiety", "Fun-Seeking", "Drive", "Reward-Responsiveness"],
    reportLinks: {
      measure:
